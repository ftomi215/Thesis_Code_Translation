...
terms of textual similarity and functional correctness. This
suggests that task-specific adaptation is an effective way to improve code
translation quality, even when relatively small parameter-efficient fine-tuning
methods are used. The experiments also showed that different model families do
not benefit equally from fine-tuning, indicating that architecture and
pre-training strategy can strongly influence the final translation performance.
