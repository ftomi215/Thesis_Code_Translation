...
the Java-to-C++ translation task. The Qwen model achieved a higher average BLEU score than the base StarCoder2 model, and it also
...
highest number of accepted solutions among all evaluated models. These findings are therefore consistent with prior evidence that Qwen2.5-Coder performs strongly across code-related
tasks, while extending this observation to the translation setting examined in
this thesis.
