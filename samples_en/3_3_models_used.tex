...
outperforms several other code models of similar size on standard programming
benchmarks.
...
Low-Rank Adaptation (LoRA), which adds small trainable matrices to selected
...
models are loaded in 4-bit mode and trained using mixed precision and gradient
