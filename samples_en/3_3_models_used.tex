...
\subsection{Base Models} %szb: ne használd a base modellt, mert a qwen modell instruction-tuned. Lehet, hogy csak simán hagyd el a subsection-öket
...
%szb: itt elgondolkoztam... A prompt-od, amit fentebb írsz, nem instrukciós kérdés/válaszos jellegű... Ez nyílván okés starcoderhez, de a qwencodert ugye a saját chat template-jével promptolod kiértékeléskor meg tanításkor?

\subsection{Fine-Tuned Models}

In addition to the original pre-trained models, fine-tuned variants of both
StarCoder2 and Qwen2.5-Coder %szb: légy következetes a nevekben, a méret és a tuning is a név része - főleg azért, hogy nehogy azt higgye az olvasó, hogy it ttényleg a base-modelről van szó (hiszen annak a nevében ugyancsak nincs ott az instruct szócska)
were prepared for the Java-to-C++ translation task. Fine-tuning was performed
using Low-Rank Adaptation (LoRA), which adds small trainable matrices to
selected layers of the model while keeping the original weights frozen
