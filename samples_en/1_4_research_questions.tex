...
\begin{itemize}
    ...
    \item \textbf{ {\color{red}RQ5: What are the main limitations of current
    approaches, and how can they be addressed?}} \\
    {\color{red} This question identifies key weaknesses of existing methods and
    outlines potential directions for improvement. }
\end{itemize}
